...
| `int16x4_t __riscv_ssha_s_i16x4(int16x4_t rs1, int shamt);`                         | `pssha.hs`(RV64), `pssha.dhs`(RV32)                                                         |                                                    |
| `int32x2_t __riscv_ssha_s_i32x2(int16x4_t rs1, int shamt);`                         | `pssha.ws`(RV64), `pssha.dws`(RV32)                                                         |                                                    |
| `int16x4_t __riscv_sshar_s_i16x4(int32x2_t rs1, int shamt);`                        | `psshar.hs`(RV64), `psshar.dhs`(RV32)                                                       |                                                    |
| `int32x2_t __riscv_sshar_s_i32x2(int32x2_t rs1, int shamt);`                        | `psshar.ws`(RV64), `psshar.dws`(RV32)                                                       |                                                    |
